...
export function App() {
  ...
  if (!isAuthenticated || showAuthModal) {
    return (
      <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-0 sm:p-6 relative overflow-hidden font-sans antialiased selection:bg-[#4F8EF7] selection:text-white">
